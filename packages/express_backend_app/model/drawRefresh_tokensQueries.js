...
// id UUID PRIMARY KEY DEFAULT gen_random_uuid(), userid TEXT UNIQUE, token TEXT UNIQUE, expires_at timestamptz, revoked boolean DEFAULT false, rotated_from uuid 
